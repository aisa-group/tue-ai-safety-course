...
| **Re-exam**   | 6 October 2026, 17:00 – 19:00, Hörsaal A1 (A-206), Cyber Valley Campus, Maria-von-Linden-Str. 1 |
...
A written exam with free-form questions covering the lecture material. For examples of questions, see `exam/mock_exam.pdf`. Note that the final exam will take 2 hours, cover 11 lectures (i.e., all, excluding the first two), and will have 3 questions per lecture (i.e., 33 questions total).
...
| 11 | 29.06 | Sahar     | [**Multi-agent safety.**](lecture-slides/lecture-11-multi-agent-safety.html) Information propagation, collusion, steganography                  |
| 12 | 06.07 | Maksym    | [**Automating AI R&D.**](lecture-slides/lecture-12-ai-rnd-automation.html) Recursive self-improvement, benchmarks (MLE-bench, PostTrainBench, KernelBench, InferenceBench), AI control, and scalable oversight |
